...
pub const DependencyManager = struct {
    ...
    pub fn fetchLatest(self: *DependencyManager, repo: []const u8) !Dependency {
        ...
        return .{
            ...
            .cmake_package = if (std.mem.eql(u8, name, "json")) try self.allocator.dupe(u8, "nlohmann_json") else null,
            .include_path = if (std.mem.eql(u8, name, "json")) try self.allocator.dupe(u8, "single_include") else null,
        };
    }
}; 